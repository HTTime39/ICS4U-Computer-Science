...
/*========== Wall Collision JS for each Room ==========*/
function collisionRoom0()
{
    ...
    //HORIZONTAL
    if (snakeY + snakeHeight == wall0AY && snakeY + snakeHeight <= wall0AY + wallHeightH)
    {
        if (snakeX + snakeWidth > wall0AX && snakeX < wall0AX + wallWidthH)
        {
            bottomStop = true;
        }
        else
    ...
    //VERTICAL
    else if (snakeY + snakeHeight == wall1Y && snakeY + snakeHeight <= wall1Y + wallHeightV)
    {
